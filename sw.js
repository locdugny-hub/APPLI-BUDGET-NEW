/* Service worker v7.5.16 : réseau d'abord, cache hors-ligne.
...
async function patchedApp(req){
  ...
  const [p75,p752,p753,p754,p755,p756,p757,p758,p759,p7510,p7511,p7512,p7513,p7515,p7516]=await Promise.all([
